...
bool TetrahedralizationSolution::tetra()
{
    ...
    in.save_nodes("scene/test/tetrahedron/barin");
    in.save_poly("scene/test/tetrahedron/barin");
    ...
    out.save_nodes("scene/test/tetrahedron/barout");
    out.save_elements("scene/test/tetrahedron/barout");
    out.save_faces("scene/test/tetrahedron/barout");
